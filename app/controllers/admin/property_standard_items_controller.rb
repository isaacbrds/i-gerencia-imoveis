  ...
  class PropertyStandardItemsController < BaseController
    ...
    def create
      ...
      if @property_standard_item.save
        redirect_to admin_property_standard_items_path, notice: 'Característica criado com sucesso!'
      else
    ...
    def update
      if @property_standard_item.update property_standard_item_params
        redirect_to admin_property_standard_items_path, notice: 'Característica atualizado com sucesso!'
      else
    ...
    def destroy
      ...
      redirect_to admin_property_standard_items_path, notice: 'Característica excluído com sucesso!'
    end
